...
begin
  ...
  insert into public.tasks (title, description, due_date, estimated_minutes, created_by)
  values (trim(p_title), trim(p_description), p_due_date, p_estimated_minutes, (select auth.uid()))
...
begin
  ...
  select s.assignment_id, a.user_id, s.review_status
  into target_assignment_id, target_user_id, previous_status
  from public.submissions s
  join public.assignments a on a.id = s.assignment_id
